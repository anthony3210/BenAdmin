...
//RequestObject ro = findTestObject('Client Person/Services/Client/Create Client/CreateClient 3');
...
body2 = body2.replaceAll(/\s{2,}/, ' '); // body is now a Java.Lang.String (immutable)
body2 = body2.replaceAll(/(\"$\{)/,'\\\1');
println body2;
body2 = '{"query":"' + body2;
