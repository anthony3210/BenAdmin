...
json = /{"query":"mutation {createAddress(address:{addressLine1: \"169 Smith Street\", addressLine2: \"line2\", city: \"Chicago\", postalCode: \"60014\", stateProvinceCode: \"IL\", attention: \"Laura\", county: \"McHenry\", countryISOCode: \"US\"}){addressUUID addressLine1 addressLine2 city stateProvinceCode postalCode attention county countryISOCode}}"}/
url = 'https://api.benadmin.qa.maestroedgy.com/graphql'

// make request
response = WS.sendRequestAndVerify(CustomKeywords.'benAdminQA.RequestSetup.testRequestJSON'(url, json))
